...
export default function TemplateLibrary({ isAdmin, onEditTemplate, onUploadNew }: Props) {
  const { templates, loading } = useCertificateTemplatesStream();
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={onUploadNew}
          className="ml-auto bg-[#83358E] text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-[#5B1F6B] transition-colors flex items-center gap-1.5"
        >
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-[#9E9E9E] text-sm mt-1 mb-5">Upload your first certificate template background to get started.</p>
          ...
          {filtered.map(t => (
            <div key={t.id} className="bg-white rounded-2xl border border-[#E0E0E0] overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-4 space-y-2">
                ...
                <p className="text-[#9E9E9E] text-xs">A4 Landscape (297×210mm)</p>
                ...
                <p className="text-[#9E9E9E] text-xs font-medium">
