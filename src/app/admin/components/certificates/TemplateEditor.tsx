...
import { saveCertificateTemplate } from "../../../modules/certificates/services/certificate.service";
...
export default function TemplateEditor({ isAdmin, templateId, onSave }: Props) {
  const { templates } = useCertificateTemplatesStream();
    ...
    <div className="flex gap-5 h-[calc(100vh-160px)]" onMouseMove={onMouseMove} onMouseUp={onMouseUp}>
      ...
      <div className="flex-1 bg-[#F0F0F0] rounded-2xl overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-auto flex items-center justify-center p-8">
          {!hasTemplate ? (
            <label
              className="border-2 border-dashed border-[#001A4D]/30 rounded-2xl flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-[#001A4D]/60 transition-colors p-8 relative"
            ...
            >
              ...
              <p className="text-[#9E9E9E] text-xs text-center">JPG or PNG image · Recommended Landscape A4 aspect ratio (297 × 210 mm)</p>
              <span className="bg-[#83358E] text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-[#5B1F6B] transition-colors mt-2">
                Browse Image File
              </span>
            </label>
          ) : (
      ...
      <div className="w-80 bg-white border border-[#E0E0E0] rounded-2xl flex flex-col overflow-hidden flex-shrink-0">
        ...
        <div className="p-4 space-y-5 flex-1 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-[#E0E0E0] rounded-lg text-sm focus:outline-none focus:border-[#83358E]"
            />
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="block text-[10px] text-[#9E9E9E] mb-1">Font Size (pt)</label>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className={`w-full py-2.5 rounded-lg text-white text-xs font-bold flex items-center justify-center gap-2 transition-all ${
                isAdmin ? "bg-[#001A4D] hover:bg-[#0E4EBD]" : "bg-[#83358E] hover:bg-[#5B1F6B]"
              }`}
            >
          ...
          <div className="space-y-3 pt-2">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-[#9E9E9E] text-xs">Set as Default Template</span>
            </label>
          </div>
        </div>
      </div>
